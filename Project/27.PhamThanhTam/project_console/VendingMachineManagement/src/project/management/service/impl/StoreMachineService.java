...
public class StoreMachineService implements IStoreMachineService{
	...
	public void deleteStoreMachine(int id) {
		storeMachineRepository.deleteStoreMachine(id);
	...
	public StoreMachineEntity addStoreMachine(StoreMachineEntity storeMachineEntity) {
		return storeMachineRepository.findOne(storeMachineRepository.addStoreMachine(storeMachineEntity));
	}

	@Override
	public StoreMachineEntity updateStoreMachine(StoreMachineEntity storeMachineEntity) {
		storeMachineRepository.updateStoreMachine(storeMachineEntity);
		return storeMachineRepository.findOne(storeMachineEntity.getId());
	}
