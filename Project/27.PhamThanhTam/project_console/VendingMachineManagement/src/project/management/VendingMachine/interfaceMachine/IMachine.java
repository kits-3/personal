package project.management.VendingMachine.interfaceMachine;
...
public interface IMachine {
	...
	void saveCountProduct(List<ProductEntity> productEntities, HashMap<String, Integer> orderProduct);
}
