package project.management.VendingMachine.interfaceMachine.impl;
...
import project.management.VendingMachine.Thread2.thread;
...
public class Machine implements IMachine {
	private IOrderItemProductService orderItemProductService;
	private IOrderItemService orderItemService;
	private IProductService productService;
	private Scanner scan;
	public Machine() {
		this.orderItemProductService = new OrderItemProductService();
	...
	public void recept(List<ProductEntity> product, int[] count, String chance) {
		...
		try {
			...
			FileOutputStream outputStream = new FileOutputStream(
					"src/project/management/VendingMachine/fileBill/bill.txt");
