...
public class UserRepositoryImpl implements IUserRepository{
	...
	@Override
	public String getTaskNameByUserId(int idUser) {
		String getUserName = "";
		try {
	...
	@Override
	public String getUserNameByTaskDetail(int idTaskDetail) {
		String getUserName = "";
		try {
			String queryString = "SELECT * FROM user WHERE id = (SELECT owner FROM task WHERE id = (SELECT task_id FROM taskdetail WHERE task_id = ? GROUP BY task_id))";
			connection = getConnection();
			stmt = connection.prepareStatement(queryString);
