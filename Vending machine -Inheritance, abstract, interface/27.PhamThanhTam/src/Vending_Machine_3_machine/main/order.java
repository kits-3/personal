...
public class order {
	public void order_machine(boolean checkMore, int money,String[] product,int[] productPrice,int count1,int count2 , int count3,HashMap<String,Integer> orderProduct ) {
