...
public class Vending_Machine_BaiSua {
...
//		}
		...
		while (checkMore) {
			...
			// Giúp khỏi set cứng cái min của nó
			if (money < productAPrice && money < productBPrice && money < productCPrice) {
				...
				while (checkMore) {
					System.out.println("please select product 1." + productA + "(" + productAPrice + ") 2." + productB
							+ "(" + productBPrice + ") 3." + productC + "(" + productCPrice + ")");
